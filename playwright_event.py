...
with sync_playwright() as playwright:
    ...
    # Можно добавлять и удалять обработчики событий динамически:
    ...
    # Фильтрация событий Если вам нужно логировать только определённые запросы, используйте фильтрацию:
   ...
   # page.on("request", log_specific_requests)
    ...
    # Работа с ответами Вы можете получить дополнительную информацию о содержимом ответа:
